...
const s = {
  ...
  heroP: { fontSize: '1.06rem', lineHeight: 1.8, color: c.muted, marginBottom: '32px', maxWidth: '560px', fontWeight: 500 },
  ...
  statLabel: { fontSize: '13px', color: c.muted, marginTop: '6px', fontWeight: 600 },
  ...
  p: { fontSize: '1.04rem', lineHeight: 1.84, color: c.muted, marginBottom: '16px', maxWidth: '600px', fontWeight: 500 },
  ...
  cardP: { fontSize: '0.96rem', lineHeight: 1.8, color: c.muted, fontWeight: 500 },
  ...
  input: { width: '100%', padding: '12px 16px', background: 'rgba(255,255,255,0.09)', border: '1px solid rgba(255,255,255,0.22)', color: '#fff', fontFamily: 'inherit', fontSize: '1rem', fontWeight: 600, outline: 'none', borderRadius: '6px', display: 'block', marginBottom: '16px', boxSizing: 'border-box' },
  textarea: { width: '100%', padding: '12px 16px', background: 'rgba(255,255,255,0.09)', border: '1px solid rgba(255,255,255,0.22)', color: '#fff', fontFamily: 'inherit', fontSize: '1rem', fontWeight: 500, outline: 'none', borderRadius: '6px', resize: 'none', display: 'block', marginBottom: '16px', boxSizing: 'border-box' },
  footer: { padding: '24px 60px', borderTop: `1px solid ${c.border}`, display: 'flex', justifyContent: 'space-between', fontSize: '13px', color: c.muted, background: c.bg, fontWeight: 600 },
};
