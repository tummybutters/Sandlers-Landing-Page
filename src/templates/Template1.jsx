...
const s = {
  ...
  navLinks: { display: 'flex', gap: '28px', fontSize: '11px', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', fontFamily: 'system-ui, sans-serif', color: c.muted },
  ...
  heroP: { fontSize: '1.08rem', lineHeight: 1.82, color: c.muted, maxWidth: '560px', marginBottom: '38px', fontFamily: 'system-ui, sans-serif', fontWeight: 500 },
  ...
  label: { fontSize: '9px', letterSpacing: '0.45em', textTransform: 'uppercase', color: c.gold, marginBottom: '20px', fontFamily: 'system-ui, sans-serif', display: 'block', fontWeight: 700 },
  h2: { fontSize: 'clamp(2.4rem, 4vw, 3.7rem)', fontWeight: 600, fontStyle: 'italic', lineHeight: 1.02, marginBottom: '28px' },
  p: { fontSize: '1.03rem', lineHeight: 1.88, color: c.muted, marginBottom: '18px', fontFamily: 'system-ui, sans-serif', fontWeight: 500, maxWidth: '600px' },
  ...
  svcP: { fontSize: '0.95rem', lineHeight: 1.8, color: c.muted, fontFamily: 'system-ui, sans-serif', fontWeight: 500 },
  ...
  input: { background: 'transparent', border: 'none', borderBottom: `1px solid ${c.rule}`, padding: '10px 0', color: c.text, fontFamily: 'Georgia, serif', fontSize: '1rem', fontWeight: 600, outline: 'none', width: '100%', display: 'block', marginBottom: '20px' },
  textarea: { background: c.bg, border: `1px solid ${c.rule}`, padding: '14px', color: c.text, fontFamily: 'Georgia, serif', fontSize: '1rem', fontWeight: 500, outline: 'none', width: '100%', resize: 'none', display: 'block', marginBottom: '20px' },
  footer: { padding: '24px 60px', borderTop: `1px solid ${c.rule}`, display: 'flex', justifyContent: 'space-between', fontSize: '0.82rem', color: c.muted, fontFamily: 'system-ui, sans-serif', fontWeight: 600 },
};
