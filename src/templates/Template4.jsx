...
const s = {
  ...
  navLinks: { display: 'flex', gap: '36px', fontSize: '12px', letterSpacing: '0.18em', textTransform: 'uppercase', fontFamily: 'system-ui, sans-serif', color: c.muted, fontWeight: 700 },
  ...
  heroBadge: { fontSize: '10px', letterSpacing: '0.5em', textTransform: 'uppercase', color: c.burgundyLight, marginBottom: '24px', display: 'block', fontFamily: 'system-ui, sans-serif', fontWeight: 700 },
  ...
  heroP: { fontSize: '1.06rem', lineHeight: 1.84, color: c.muted, maxWidth: '560px', margin: '0 auto 38px', fontFamily: 'system-ui, sans-serif', fontWeight: 500 },
  ...
  label: { fontSize: '10px', letterSpacing: '0.45em', textTransform: 'uppercase', color: c.burgundyLight, marginBottom: '16px', display: 'block', fontFamily: 'system-ui, sans-serif', fontWeight: 700 },
  ...
  p: { fontSize: '1.04rem', lineHeight: 1.92, color: c.muted, marginBottom: '18px', fontFamily: 'system-ui, sans-serif', fontWeight: 500 },
  ...
  svcP: { fontSize: '0.96rem', lineHeight: 1.84, color: c.muted, fontFamily: 'system-ui, sans-serif', fontWeight: 500 },
  ...
  input: { width: '100%', padding: '10px 0', background: 'transparent', border: 'none', borderBottom: `1px solid ${c.border}`, color: c.text, fontFamily: 'Georgia, serif', fontSize: '1rem', fontWeight: 600, outline: 'none', display: 'block', marginBottom: '20px', boxSizing: 'border-box' },
  textarea: { width: '100%', padding: '12px', background: c.bg, border: `1px solid ${c.border}`, color: c.text, fontFamily: 'system-ui, sans-serif', fontSize: '1rem', fontWeight: 500, outline: 'none', resize: 'none', display: 'block', marginBottom: '20px', boxSizing: 'border-box' },
  footer: { padding: '22px 60px', borderTop: `1px solid ${c.border}`, display: 'flex', justifyContent: 'space-between', fontSize: '11px', letterSpacing: '0.12em', color: c.muted, fontFamily: 'system-ui, sans-serif', fontWeight: 600 },
};
