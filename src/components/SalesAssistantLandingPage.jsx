...
export default function SalesAssistantLandingPage() {
  useSecretRouteMeta('Qortana Sales Assistant Intake');
      ...
      <main className="landing-main">
        ...
        >
          ...
          <div className="landing-cta-row">
            <Link to="/sales-assistant-intake/quiz" className="landing-cta-primary">
